...
const SignUpAsEnterpriseScreen = () => {
  useProtectRoute()
  useEffect(() => {
    ...
    <SignupStyle>
      <div className="signup">
        ...
        <div className="signup_content ">
          <span className="signup_content_title">Sign Up As Enterprise</span>
          ...
          >
            ...
            <Form.Item>
              ...
              <Link style={{ color: "blue" }} to={"/enterprise/login"}>
                Sign in
              </Link>
            </Form.Item>
            <Form.Item>
...
export default SignUpAsEnterpriseScreen;
